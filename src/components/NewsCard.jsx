...
export default function NewsCard({ article, featured = false, headingLevel = 3 }) {
  ...
  const cardClassName = featured
    ...
    : 'group overflow-hidden rounded-2xl border border-navy-900/15 bg-white/45 shadow-soft backdrop-blur-sm transition-all hover:-translate-y-1 hover:bg-white/55 hover:shadow-[0_18px_44px_rgba(4,30,66,0.18)]';
  ...
  return (
    <article className={cardClassName}>
      ...
      <div className={featured ? 'flex flex-col justify-center p-6 sm:p-8' : 'p-6'}>
        <ArticleByline authorName={article.author_name} publishedAt={article.published_at} />
