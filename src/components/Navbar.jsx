...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 bg-navy-900">
      <div className="mx-auto flex min-h-[4.75rem] max-w-6xl items-center justify-between gap-2 px-3 py-2 sm:px-6 lg:px-10">
        <div className="min-w-0">
          <span className="block font-serif text-sm leading-none text-white tracking-tightish min-[380px]:text-base sm:text-xl">
              Rizvi&amp;ivziЯ
          </span>
          <NavLink
            to="/"
            aria-label="FederalCorporation home"
            className="mt-1 flex min-w-0 items-center gap-2 rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:gap-3"
          >
            <img
              src={logo}
              alt=""
          ...
          <span className="mt-1 block max-w-[10.5rem] text-[7px] font-medium uppercase leading-tight tracking-[0.06em] text-white/70 min-[380px]:text-[8px] sm:max-w-none sm:whitespace-nowrap sm:text-[10px] sm:tracking-[0.12em]">
