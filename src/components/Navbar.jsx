    ...
    <header className="sticky top-0 z-50 bg-navy-900">
      <div className="mx-auto flex h-[4.5rem] max-w-6xl items-center justify-between gap-2 px-4 sm:px-6 lg:px-10">
        <div className="grid min-w-0 grid-cols-[auto_auto] grid-rows-[auto_auto] items-center gap-x-2 sm:gap-x-3">
          <span className="min-w-0 truncate font-serif text-base leading-none text-white tracking-tightish sm:text-xl">
              Rizvi&amp;ivziЯ
          </span>
          <NavLink
            to="/"
          ...
          >
            <img
              ...
              height="36"
              decoding="async"
              className="hidden h-9 w-9 rounded-full object-contain xs:block sm:block"
            />
            <span className="truncate font-serif text-base text-white tracking-tightish sm:text-xl">
              FedCorp
            </span>
          </NavLink>
          <span className="col-start-1 row-start-2 mt-1 max-w-[11rem] text-[8px] font-medium uppercase leading-tight tracking-[0.08em] text-white/70 sm:max-w-none sm:whitespace-nowrap sm:text-[10px] sm:tracking-[0.12em]">
      ...
      <div>
        <div className="mx-auto max-w-6xl px-4 py-3 sm:px-6 lg:px-10">
          <nav aria-label="Primary navigation" className="flex justify-start gap-2 overflow-x-auto pb-1 sm:justify-center sm:pb-0">
            {nav.map((item) => (
